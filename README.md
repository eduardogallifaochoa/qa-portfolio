...
### DevOps Kubernetes AWS Showcase
**Tech:** FastAPI, Docker, Kubernetes, GitHub Actions, GHCR, AWS  
Production-like DevOps showcase with DEV/QA environments in Docker Compose and kind Kubernetes, CI/CD workflows, and an AWS deployment roadmap.

Repository: https://github.com/eduardogallifaochoa/devops-kubernetes-aws-showcase

## Stack
- **Languages:** Python, JavaScript, TypeScript, SQL  
- **Automation:** Playwright, Pytest, Selenium  
- **DevOps:** GitHub Actions, Docker, PyInstaller  
- **Cloud/Infra:** Kubernetes, AWS (deployment planning)  
